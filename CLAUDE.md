...
- **Name**: Nick
- **Machine**: Mac
- **Experience**: Complete beginner — hasn't built anything before
- **Motivation**: Wants to build a commercial energy bill upload app for New Jersey — analyze bills, pull out key terms, start with auth + database + landing page
- **Terminal comfort**: 1 / 5
